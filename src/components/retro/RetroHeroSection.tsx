...
import RetroWorkstation3DCanvas from "./RetroWorkstation3DCanvas";
import { retroAudio } from "./RetroAudio";

interface RetroHeroSectionProps {
  activeTab: NavTab;
...
export default function RetroHeroSection({
  ...
  return (
    <section className="relative min-h-screen w-full bg-[#fafbfc] text-slate-900 pt-28 pb-16 px-6 sm:px-12 flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center my-auto">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center space-y-7 select-none">
          ...
          {/* Bold Typography matching the exact design */}
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center relative">
          ...
          <div className="w-full flex items-center justify-center relative z-10">
            <RetroWorkstation3DCanvas
              ...
              onNavigateSection={onScrollToDashboard}
            />
          </div>
